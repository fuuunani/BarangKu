...
<body class="hold-transition login-page">
	<div class="login-box">
		...
		<div class="login-box-body">
			<p class="login-box-msg">Pengguna harus login terlebih dahulu !</p>
			<form action="{{ route('login.post') }}" method="POST">
				...
				<div class="row">
					<div class="col-xs-12">
						<button type="button" class="btn btn-primary btn-login btn-block btn-flat">Sign In</button>
					</div>
				</div>
			</form>
			<div class="social-auth-links text-center">
				<p>- OR -</p>
				<a href="{{ url('register') }}" class="btn btn-warning btn-block btn-flat">Register a new member</a>
			</div>
		</div>
	</div>
	<script>
